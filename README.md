...
**Строка 1 — скорость потока:**

| Метрика | Определение | Хорошо | Плохо |
|---|---|---|---|
| **Throughput** | `completedCount[n] − completedCount[n-1]` между двумя последними снапшотами | > 0 | = 0 |
